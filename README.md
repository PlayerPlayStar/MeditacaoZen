...
## Metodologia ##
![alt text](images/metodologia-ATII.jpeg)
*Cronograma de como o projeto foi desenvolvido*


## Imagens do Aplicativo ##
![Tela inicial, com opções de temporizador](images/meditacaozen_1.png)
*Tela inicial, com opções de temporizador e cores de fundo*

![Adição de áudios personalizados](images/meditacaozen_audios.png)
*Adição de áudios personalizados pelo usuário*
